...
public class Message implements Serializable {
    ...
    public enum Type {
        ...
        // separate LOGIN flow so the server can distinguish "sign in to existing
        // account"
        // from REGISTER ("create a new account"). Needed for persistent JSON user
        // store.
        ...
        // GAME_OVER is now client→server too (client reports the winning username),
        ...
        // FORFEIT — mid-game concede. Server records it as a loss for the forfeiter.
        FORFEIT, // client→server : concede mid-game (counts as a loss)

        // user-info lookup (powers the profile panel)
